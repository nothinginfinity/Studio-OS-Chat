...
export interface ChartSpec {
  /** Unique id for this chart (uuid or deterministic from fileId+index) */
  id: string;
  type: ChartType;
  title: string;
  xKey: string;
  yKeys: string[];
  /** Whether this chart was generated by a local template or an LLM */
  source: 'template' | 'llm';
}
...
export interface FileRecord {
  ...
  sourceFileId?: string;
  csvMeta?: CsvMeta;
  /** Auto-generated template charts produced at ingestion time */
